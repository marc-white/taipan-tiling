...
def generate_tiling_funnelweb_mp(candidate_targets, standard_targets,
    ...
    for range_ix, mag_range in enumerate(mag_ranges):
        candidate_targets, candidate_targets_range, tile_list = greedy_tile_mag_range(
            candidate_targets, standard_targets, guide_targets, candidate_tiles, 
            ranking_method, disqualify_below_min, exp_base, mag_ranges, 
            completeness_target, completeness_priority, recompute_difficulty, 
            randomise_pa, tile_unpick_settings, mag_ranges_prioritise, 
